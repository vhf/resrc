...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'link_link', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tag.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.language'
        db.delete_column(u'link_link', 'language_id')
