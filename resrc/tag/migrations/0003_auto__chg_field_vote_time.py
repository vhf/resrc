...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tag_vote', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Vote.time'
        db.alter_column(u'tag_vote', 'time', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
