    ...
    b.widget("ui.tagit", {
        ...
        _create: function () {
            ...
            this.tagInput.keydown(function (c) {
                ...
                } else a.options.removeConfirmation && a._lastTag().removeClass("remove ui-state-highlight"); if (c.which === b.ui.keyCode.COMMA || c.which === b.ui.keyCode.ENTER || c.which == b.ui.keyCode.TAB &&
        ...
        createTag: function (a, d, c) {
            ...
            !1 !== this._trigger("beforeTagAdded", null, {
                ...
                duringInitialization: c
            }) && (this.options.singleField && (g = this.assignedTags(), g.push(a), this._updateSingleTagsField(g)), this._trigger("onTagAdded", null,
                f), this.tagInput.val(""), this.tagInput.parent().before(f), this._trigger("afterTagAdded", null, {
                tag: f,
                tagLabel: this.tagLabel(f),
                duringInitialization: c
